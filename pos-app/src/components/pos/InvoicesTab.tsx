...
const InvoicesTab: React.FC<InvoicesTabProps> = ({ sessionId }) => {
  ...
  useEffect(() => {
    const fetchInvoices = async () => {
      ...
      setLoading(true);
      try {
        const result = await invoicesService.getInvoicesBySession(sessionId);
  ...
  return (
    <div className="flex-1 overflow-auto p-6 bg-white dark:bg-gray-900">
      {/* Header */}
      <div className="mb-4">
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-200">Session Invoices</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Invoices created during this POS session
        </p>
      </div>
      ...
      {!sessionId ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {/* Summary */}
          <div className="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/80 px-6 py-3 flex justify-between items-center">
